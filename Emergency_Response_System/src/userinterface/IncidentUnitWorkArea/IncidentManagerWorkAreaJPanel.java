...
public class IncidentManagerWorkAreaJPanel extends javax.swing.JPanel {
    ...
    private void manageOrganization(){
        ...
        manageUserAccount.setBackground(new Color(215,81,81));
        manageScenePanel.setBackground(new Color(215,81,81));
        IncidentManagerManageEmployeeJPanel manageEmployeeJPanel = new IncidentManagerManageEmployeeJPanel(userProcessContainer, enterprise);
    ...
    private void manageUser(){
       ...
       private void manageIncidentScene(){
        ...
        manageOrganizationPanel.setBackground(new Color(215,81,81));
        manageEmployee.setBackground(new Color(215,81,81));
       IncidentManagerSceneManageJPanel manageSceneJPanel = new IncidentManagerSceneManageJPanel(userProcessContainer, enterprise, system, organization);
    ...
    private void initComponents() {
        ...
        jLabel3.setText("INCIDENT UNIT SYSTEM");
